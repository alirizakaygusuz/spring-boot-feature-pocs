package com.alirizakaygusuz.jwt_verification_otp_token_poc.authentication.refreshtoken.controller;
...
public class RefreshTokenController extends BaseResponseController {
	...
	public ResponseEntity<StandardApiResponse<RefreshTokenResponse>> rotateToken(@RequestBody  @Valid RefreshTokenRequest request , HttpServletRequest httpServletRequest){
	...
	@PostMapping("/logout")
	public ResponseEntity<StandardApiResponse<String>> logout(@RequestBody @Valid RefreshTokenRequest request ,HttpServletRequest httpServletRequest){	
