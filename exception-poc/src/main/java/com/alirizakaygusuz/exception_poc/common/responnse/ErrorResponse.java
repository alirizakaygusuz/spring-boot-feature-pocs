...
import com.alirizakaygusuz.exception_poc.common.util.HostUtils;
...
public class ErrorResponse<T> {
	...
	private ErrorResponse(String code, String i18nKey, String path, LocalDateTime timestamp, String hostName, T message,
	...
	//Normal Error
	public static <T> ErrorResponse<T> of(WebRequest request, String code, String i18nKey, T message) {
